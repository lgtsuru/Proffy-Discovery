...
Database.then(async(db)=>{
    ...
    classValue = {
        subject: 1,
        cost: "20",
        //proffyid vira pelo banco de dado
    }
    ...
    //o horario que a pessoa trabalha é das 8:00 ate as 18:00. O horario do time_from (8hrs) precisa ser antes ou igual ao solicitado e o time_to precisa ser acima
